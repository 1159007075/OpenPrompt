...
from openprompt import PromptDataLoader, ProtoVerbClassificationRunner

train_dataloader,validation_dataloader,test_dataloader=0,0,0
#tarin valid test 数据加载器
def dataloder():
